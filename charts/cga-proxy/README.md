...
| orchestrator.image.sha256 | string | `"45f5d605ca9cb9d65c8196aaba2b513131b9a3bd256ee06140ab12b6e7e7be5d"` | Docker image checksum |
| orchestrator.image.tag | string | `"1.3.9"` | Docker image tag |
